...
(function (Path) {
     ...
     * @param str
     */
    Path.slashCount = function (str) { return str.split('/').length - 1; };
    /**
     * makePathStep
     * @param num
     */
    Path.makePathStep = function (num) { return '../'.repeat(num); };
    /**
     * split
     * @param name
     */
    Path.split = function (name) {
...
(function (File) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!!Path.isExist(fileFolderPath)) return [3 /*break*/, 3];
                    return [4 /*yield*/, File.createPath(fileFolderPath)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, File.writeFileAsync(filePath, value)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
                case 3: return [4 /*yield*/, File.writeFileAsync(filePath, value)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
     ...
     * @param value
     */
    File.writeFileAsync = function (filePath, value) {
        return new Promise(function (resolve, reject) {
            return fs_1.writeFile(filePath, value, 'utf8', function (err) {
     ...
     * @param {string} joinContent
     */
    function joinFile(filePath, anchorContent, joinContent) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, File.read(filePath)];
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, File.writeFileAsync(filePath, res.replace(anchorContent, anchorContent.concat(joinContent)))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    File.createPath = function (path) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!Path.isExist(path)) return [3 /*break*/, 1];
                    return [2 /*return*/];
                case 1: return [4 /*yield*/, File.createPath(path_1.dirname(path))];
                case 2:
                    _a.sent();
    ...
    (function (Json) {
         ...
         * @param json
         */
        Json.read = function (json) {
            return JSON.parse(fs_1.readFileSync(json));
        };
