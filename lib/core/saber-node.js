...
(function (File) {
     ...
     * @returns
     */
    function dirDeepSearch(filePath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        result = [];
                        search = function (filePath) { return __awaiter(_this, void 0, void 0, function () {
                            var files, _i, files_1, filename, filedir, stats;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, File.readDir(filePath)];
                                    case 1:
                                        files = _a.sent();
                                        _i = 0, files_1 = files;
                                        _a.label = 2;
                                    case 2:
                                        ...
                                        filename = files_1[_i];
                                        filedir = path_1.join(filePath, filename);
                        ...
                        return [4 /*yield*/, search(filePath)];
                    case 1:
                        _a.sent();
