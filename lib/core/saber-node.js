...
(function (File) {
     ...
     * @param value
     */
    File.pushFile = function (filePath, value) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
     ...
     * @param path
     */
    File.edit = function (path) { return function (callback) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_j) {
            switch (_j.label) {
                ...
                case 1: return [4 /*yield*/, _b.apply(_a, _c.concat([_e.apply(_d, [_f.apply(void 0, [_h.apply(_g, [_j.sent()])]), null, 2])]))];
                case 2:
                    _j.sent();
                    return [2 /*return*/];
            }
...
(function (Server) {
    ...
    var requestListener = function (rootDir) { return function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        var url, data_fromLocal, data_fromReq;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, File.read(url)];
                case 1:
                    data_fromLocal = _a.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, File.pushFile(url, data_fromReq)];
                case 5:
                    _a.sent();
                    res.end();
                    return [2 /*return*/];
                case 6:
                    ...
                    return [4 /*yield*/, File.createFile(url, data_fromReq)];
                case 7:
                    _a.sent();
                    res.end();
                    return [2 /*return*/];
