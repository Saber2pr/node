...
(function (Terminal) {
    ...
    (function (Print) {
         ...
         * @param message
         */
        Print.error = function (message) { return console.log('\x1b[31m', message); };
        /**
         * success
         * @param message
         */
        Print.success = function (message) { return console.log('\x1b[32m', message); };
        /**
         * tips
         * @param message
         */
        Print.tips = function (message) { return console.log('\x1b[34m', message); };
